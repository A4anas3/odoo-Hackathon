...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        // strength 12 — deliberately higher than the BCrypt default of 10
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .csrf(csrf -> csrf.disable()) // stateless JWT API, no cookies/CSRF involved
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // In production, replace "*" with an explicit allow-list of trusted origins.
